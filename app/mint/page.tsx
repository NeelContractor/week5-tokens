    ...
    <div className="w-full h-full flex flex-col justify-between">
      <div className="flex flex-col gap-4">
        ...
        <div>
          ...
          <Input value={tokenKey} onChange={(e: any) => setTokenKey(e.target.value)} />
        </div>
        <div>
          <p className="text-sm text-gray-500 mb-2">Amount</p>
          <Input type="number" value={amount} onChange={(e: any) => setAmount(e.target.valueAsNumber)} />
        </div>
        <div>
          <div className="flex justify-between mb-2">
            <p className="text-sm text-gray-500">Recipient Address *</p>
          </div>
          <Input value={recipeintKey} onChange={(e: any) => setRecipientKey(e.target.value)} />
